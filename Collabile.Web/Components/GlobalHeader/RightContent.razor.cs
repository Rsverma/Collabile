using Collabile.Web.Models;
using Collabile.Web.Services;
...
namespace Collabile.Web.Components;
public partial class RightContent
{
    private CurrentUser _currentUser = new();
    private NoticeIconData[] _notifications = System.Array.Empty<NoticeIconData>();
    private NoticeIconData[] _messages = System.Array.Empty<NoticeIconData>();
    private NoticeIconData[] _events = System.Array.Empty<NoticeIconData>();
    ...
    public async Task HandleClear(string key)
    {
        ...
        {
            case "notification":
                _notifications = System.Array.Empty<NoticeIconData>();
                break;
            case "message":
                _messages = System.Array.Empty<NoticeIconData>();
                break;
            case "event":
                _events = System.Array.Empty<NoticeIconData>();
                break;
        }
